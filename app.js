...
var Greeter = (function () {
    ...
    Greeter.prototype.reportFetcher = function () {
        console.log("jdlfjsdklf" +finalToBeSearched);
        var foodBaseURL = "https://inspections.vcha.ca/FoodPremises/Table?searchText="
        var foodFullURL = foodBaseURL + finalToBeSearched;
        console.log("222PAY ATTN :" + foodFullURL);

        var foodRes = new XMLHttpRequest();
        foodRes.onreadystatechange = function () {
            if (foodRes.readyState == 4 && foodRes.status == 200) {
               var fullRes = foodRes.response;
               //console.log(fullRes);
            }
        };
        foodRes.open("GET", foodFullURL, true);
        foodRes.send();
    };
